...
public class MyKfkConsumer {
    ...
    public void dso1(ConsumerRecord<String, String> record, Acknowledgment ack) {
        System.out.println("dso1 topics=default.specific.orderDetail > groupId= >>>");
        System.out.println("dso1 record >> " + record);
        System.out.println("dso1 record.value() >> " + record.value());
        //手动提交offset
        ack.acknowledge();
    }
    ...
    public void dso2(ConsumerRecord<String, String> record, Acknowledgment ack) {
        System.out.println("dso2 topics=default.specific.orderDetail > groupId=dso2 >>>");
        System.out.println("dso2 record >> " + record);
        System.out.println("dso2 record.value() >> " + record.value());
        ack.acknowledge();
    }
}
